...
class Main {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Krunal kevadiya", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("JAY", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("VEERU", 26, 'M');
