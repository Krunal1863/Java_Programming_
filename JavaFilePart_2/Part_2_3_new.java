...
public class Part_2_3_new {
    ...
    class Practical2_3 {
        static int getIndex(ArrayList<Part_2_3_new> persons) {
        ...
        public static void main(String argc[]) {
            ArrayList<Part_2_3_new> persons = new ArrayList<Part_2_3_new>();
            boolean flag=true;
            double money;
            int i;
            for(i=0;i<10;i++) {
                Part_2_3_new a=new Part_2_3_new();
                persons.add(a);
            }
            for(i=0;i<10;i++) {
            ...
            while(flag==true) {
                ...
                switch(x) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        Part_2_3_new p=new Part_2_3_new();
                        i=p.setbalance();
                        if(i==1) {
                            p.AccountDetail();
                            persons.add(p);
